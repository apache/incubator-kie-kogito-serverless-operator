...
func (in *Timeout) DeepCopyInto(out *Timeout) {
	*out = *in
	...
	if in.ActionExecTimeout != nil {
		in, out := &in.ActionExecTimeout, &out.ActionExecTimeout
		*out = new(string)
		**out = **in
	}
	if in.BranchExecTimeout != nil {
		in, out := &in.BranchExecTimeout, &out.BranchExecTimeout
		*out = new(string)
		**out = **in
	}
