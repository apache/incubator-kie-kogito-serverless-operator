...
type KogitoServerlessBuildSpec struct {
	...
	// Foo is an example field of KogitoServerlessBuild. Edit kogitoserverlessbuild_types.go to remove/update
...
// KogitoServerlessBuildList contains a list of KogitoServerlessBuild
