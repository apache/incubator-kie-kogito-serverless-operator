...
func (in *ServicesPlatformSpec) DeepCopyInto(out *ServicesPlatformSpec) {
	*out = *in
	if in.DataIndex != nil {
		...
		*out = new(ServicesPodTemplateSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServicesPodTemplateSpec) DeepCopyInto(out *ServicesPodTemplateSpec) {
	*out = *in
	in.Container.DeepCopyInto(&out.Container)
	in.PodSpec.DeepCopyInto(&out.PodSpec)
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServicesPodTemplateSpec.
func (in *ServicesPodTemplateSpec) DeepCopy() *ServicesPodTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(ServicesPodTemplateSpec)
