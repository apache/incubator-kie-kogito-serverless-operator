...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlowPodSpecTemplate) DeepCopyInto(out *FlowPodSpecTemplate) {
	*out = *in
	in.FlowContainer.DeepCopyInto(&out.FlowContainer)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlowPodSpecTemplate.
func (in *FlowPodSpecTemplate) DeepCopy() *FlowPodSpecTemplate {
	if in == nil {
		return nil
	}
	out := new(FlowPodSpecTemplate)
	in.DeepCopyInto(out)
	return out
}
