...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlatformPersistenceSpec) DeepCopyInto(out *PlatformPersistenceSpec) {
	*out = *in
	if in.PostgreSQL != nil {
		in, out := &in.PostgreSQL, &out.PostgreSQL
		*out = new(PostgreSQLPlatformSpec)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlatformPersistenceSpec.
func (in *PlatformPersistenceSpec) DeepCopy() *PlatformPersistenceSpec {
	if in == nil {
		return nil
	}
	out := new(PlatformPersistenceSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgreSQLPlatformSpec) DeepCopyInto(out *PostgreSQLPlatformSpec) {
	*out = *in
	out.SecretRef = in.SecretRef
	out.ServiceRef = in.ServiceRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgreSQLPlatformSpec.
func (in *PostgreSQLPlatformSpec) DeepCopy() *PostgreSQLPlatformSpec {
	if in == nil {
		return nil
	}
	out := new(PostgreSQLPlatformSpec)
