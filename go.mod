...
require (
	...
	github.com/kiegroup/kogito-serverless-operator/api v1.40.1
	github.com/kiegroup/kogito-serverless-operator/container-builder v1.40.1
	github.com/kiegroup/kogito-serverless-operator/workflowproj v1.40.1
