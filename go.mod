...
require (
	...
	github.com/kiegroup/kogito-serverless-operator/api v1.41.0
	github.com/kiegroup/kogito-serverless-operator/container-builder v1.41.0
	github.com/kiegroup/kogito-serverless-operator/workflowproj v1.41.0
